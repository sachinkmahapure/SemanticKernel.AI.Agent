...
public sealed class DatabasePluginTests : IDisposable
{
	...
	private void SeedTestData()
	{
		_db.Products.AddRange(
			new Product { Id = 11, Name = "Laptop Pro 15", Price = 1299.99m, Category = "Electronics", StockQuantity = 45, IsActive = true },
			new Product { Id = 12, Name = "Wireless Mouse", Price = 49.99m, Category = "Accessories", StockQuantity = 200, IsActive = true },
			new Product { Id = 13, Name = "Monitor 27\"", Price = 599.99m, Category = "Electronics", StockQuantity = 5, IsActive = true }, // low stock
			new Product { Id = 14, Name = "SSD 1TB", Price = 109.99m, Category = "Storage", StockQuantity = 8, IsActive = true }, // low stock
			new Product { Id = 15, Name = "USB-C Hub", Price = 79.99m, Category = "Accessories", StockQuantity = 150, IsActive = true },
			new Product { Id = 16, Name = "Webcam HD", Price = 89.99m, Category = "Electronics", StockQuantity = 120, IsActive = true },
			new Product { Id = 17, Name = "RAM 32GB", Price = 139.99m, Category = "Memory", StockQuantity = 90, IsActive = true },
			new Product { Id = 18, Name = "Keyboard", Price = 149.99m, Category = "Accessories", StockQuantity = 80, IsActive = true }
		);

		_db.Customers.AddRange(
			new Customer { Id = 11, FirstName = "Alice", LastName = "Johnson", Email = "alice@test.com" },
			new Customer { Id = 12, FirstName = "Bob", LastName = "Williams", Email = "bob@test.com" }
		);

		_db.Orders.AddRange(
			new Order { Id = 11, CustomerId = 1, TotalAmount = 1299.99m, Status = OrderStatus.Delivered, OrderDate = DateTimeOffset.UtcNow.AddDays(-10) },
			new Order { Id = 12, CustomerId = 2, TotalAmount = 49.99m, Status = OrderStatus.Pending, OrderDate = DateTimeOffset.UtcNow }
		);

		_db.OrderItems.AddRange(
			new OrderItem { Id = 11, OrderId = 1, ProductId = 1, Quantity = 1, UnitPrice = 1299.99m },
			new OrderItem { Id = 12, OrderId = 2, ProductId = 2, Quantity = 1, UnitPrice = 49.99m }
		);
